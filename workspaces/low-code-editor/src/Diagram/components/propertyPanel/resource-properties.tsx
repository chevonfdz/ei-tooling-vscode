...
export function ResourceProperty(props: Props) {
  ...
  const handleCancelClick = async () => {
    ...
    setSelectedGETMethod("GET");
    setSelectedPOSTMethod("POST");
    setSelectedPutMethod("Put");
    setSelectedDeleteMethod("Delete");
    setSelectedOptionsMethod("Options");
    setSelectedHeadMethod("Head");
    setSelectedPatchMethod("Patch");
