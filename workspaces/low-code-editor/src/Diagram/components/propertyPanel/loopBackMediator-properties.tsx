...
export default class LoopBackMediatorProperty extends Component<Props, State> {
  ...
  render() {
    ...
    return (
        <>
            <Modal.Header>
                <Modal.Title className='text-primary'>LoopBack Mediator Properties</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Row className='mb-4'>
