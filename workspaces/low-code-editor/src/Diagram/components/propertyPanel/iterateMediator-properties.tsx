...
export default class IterateMediatorProperty  extends Component<Props, State> {
                ...
                <Row className='mb-4'>
                    ...
                    <Form>
                        <Form.Group>    
                            ...
                            <Form.Control type="text" placeholder="eg: Iterate ID" />
                            <Form.Label className="IterateExpression">Iterate Expression</Form.Label>
                            ...
                            <Form.Check type="checkbox" className="PreservePayload" style={{ display: "flex", alignItems: "center" }} label={<span style={{ marginLeft: "10px" }} >Preserve Payload</span>} />
                            <br />
                            <Row className='mb-4'>
                                <Modal.Title className='text-secondary'>
                                    Sequence
