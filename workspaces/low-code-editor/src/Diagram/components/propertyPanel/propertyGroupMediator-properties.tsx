...
export default class PropertyGroupMediatorProperty extends Component<Props, State> {
                        ...
                        <Row className='mb-4'>
                            ...
                            <Form>
                                <Form.Group>
                                    ...
                                    <Form.Control as="textarea" readOnly/>  {/* When a user clicks this textbox, the Property Mediator Model appears.*/}
                                </Form.Group>
                            </Form>
                        </Row>
                    </Modal.Body>
